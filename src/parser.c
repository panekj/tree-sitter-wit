...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [53] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_file, 1, 0, 0),
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0),
  [57] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(152),
  [60] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(82),
  [63] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(167),
  [66] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(166),
  [69] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(165),
  [72] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(163),
  [75] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(143),
  [78] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(151),
  [81] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_file_repeat1, 2, 0, 0), SHIFT_REPEAT(150),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_result, 1, 0, 0),
  [86] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_result, 1, 0, 0),
  [88] = {.entry = {.count = 1, .reusable = true}}, SHIFT(7),
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stream, 1, 0, 0),
  [92] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_stream, 1, 0, 0),
  [94] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_future, 1, 0, 0),
  [96] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_future, 1, 0, 0),
  [98] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [100] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tp2, 3, 0, 0),
  [102] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tp2, 3, 0, 0),
  [104] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_stream, 2, 0, 0),
  [106] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_stream, 2, 0, 0),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_future, 2, 0, 0),
  [110] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_future, 2, 0, 0),
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tps, 5, 0, 0),
  [114] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tps, 5, 0, 0),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tuple, 2, 0, 0),
  [118] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tuple, 2, 0, 0),
  [120] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_result, 2, 0, 0),
  [122] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_result, 2, 0, 0),
  [124] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list, 2, 0, 0),
  [126] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_list, 2, 0, 0),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_option, 2, 0, 0),
  [130] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_option, 2, 0, 0),
  [132] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tp1, 3, 0, 0),
  [134] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tp1, 3, 0, 0),
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ty, 1, 0, 0),
  [138] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ty, 1, 0, 0),
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tps, 3, 0, 0),
  [142] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tps, 3, 0, 0),
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tps, 4, 0, 0),
  [146] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tps, 4, 0, 0),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tp2, 5, 0, 0),
  [150] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tp2, 5, 0, 0),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_args, 3, 0, 0),
  [154] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_args, 3, 0, 0),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_args, 4, 0, 0),
  [158] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_args, 4, 0, 0),
  [160] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_args, 2, 0, 0),
  [162] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_args, 2, 0, 0),
  [164] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_args, 5, 0, 0),
  [166] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_args, 5, 0, 0),
  [168] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_item_resource, 2, 0, 2),
  [170] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_item_resource, 2, 0, 2),
  [172] = {.entry = {.count = 1, .reusable = true}}, SHIFT(74),
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_output, 1, 0, 0),
  [176] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_output, 1, 0, 0),
  [178] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__func, 6, 0, 3),
  [180] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__func, 6, 0, 3),
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_item_resource, 3, 0, 2),
  [184] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_item_resource, 3, 0, 2),
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_flags, 4, 0, 0),
  [188] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_flags, 4, 0, 0),
  [190] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_union_items, 5, 0, 0),
  [192] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_union_items, 5, 0, 0),
  [194] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_item_flags, 3, 0, 2),
  [196] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_item_flags, 3, 0, 2),
  [198] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_items, 5, 0, 0),
  [200] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_enum_items, 5, 0, 0),
  [202] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_item_variant, 3, 0, 2),
  [204] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_item_variant, 3, 0, 2),
  [206] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variant_items, 5, 0, 0),
  [208] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variant_items, 5, 0, 0),
  [210] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_item_enum, 3, 0, 2),
  [212] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_item_enum, 3, 0, 2),
  [214] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_item_union, 3, 0, 2),
  [216] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_item_union, 3, 0, 2),
  [218] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_flags, 3, 0, 0),
  [220] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_flags, 3, 0, 0),
  [222] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_flags, 5, 0, 0),
  [224] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_flags, 5, 0, 0),
  [226] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fields, 5, 0, 0),
  [228] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_fields, 5, 0, 0),
  [230] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_item, 1, 0, 0),
  [232] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_item, 1, 0, 0),
  [234] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_item_use, 4, 0, 4),
  [236] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_item_use, 4, 0, 4),
  [238] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_item_func, 1, 0, 1),
  [240] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_item_func, 1, 0, 1),
  [242] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variant_items, 3, 0, 0),
  [244] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variant_items, 3, 0, 0),
  [246] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_union_items, 4, 0, 0),
  [248] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_union_items, 4, 0, 0),
  [250] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_items, 4, 0, 0),
  [252] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_enum_items, 4, 0, 0),
  [254] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variant_items, 4, 0, 0),
  [256] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variant_items, 4, 0, 0),
  [258] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fields, 3, 0, 0),
  [260] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_fields, 3, 0, 0),
  [262] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_resource_items, 2, 0, 0),
  [264] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_resource_items, 2, 0, 0),
  [266] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_item_type, 4, 0, 2),
  [268] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_item_type, 4, 0, 2),
  [270] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fields, 4, 0, 0),
  [272] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_fields, 4, 0, 0),
  [274] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fields, 2, 0, 0),
  [276] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_fields, 2, 0, 0),
  [278] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_item_record, 3, 0, 2),
  [280] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_item_record, 3, 0, 2),
  [282] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_resource_items, 3, 0, 0),
  [284] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_resource_items, 3, 0, 0),
  [286] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_flags, 2, 0, 0),
  [288] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_flags, 2, 0, 0),
  [290] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_union_items, 2, 0, 0),
  [292] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_union_items, 2, 0, 0),
  [294] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variant_items, 2, 0, 0),
  [296] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_variant_items, 2, 0, 0),
  [298] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_union_items, 3, 0, 0),
  [300] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_union_items, 3, 0, 0),
  [302] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_items, 3, 0, 0),
  [304] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_enum_items, 3, 0, 0),
  [306] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_enum_items, 2, 0, 0),
  [308] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_enum_items, 2, 0, 0),
  [310] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_resource_items_repeat1, 2, 0, 0), SHIFT_REPEAT(152),
  [313] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_resource_items_repeat1, 2, 0, 0),
  [315] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_resource_items_repeat1, 2, 0, 0), SHIFT_REPEAT(127),
  ...
  [324] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variant_item, 1, 0, 5),
  [326] = {.entry = {.count = 1, .reusable = true}}, SHIFT(15),
  [328] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_fields_repeat1, 2, 0, 0), SHIFT_REPEAT(119),
  [331] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_fields_repeat1, 2, 0, 0),
  [333] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_tps_repeat1, 2, 0, 0), SHIFT_REPEAT(11),
  [336] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_tps_repeat1, 2, 0, 0),
  ...
  [364] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_use_items_repeat1, 2, 0, 0), SHIFT_REPEAT(120),
  [367] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_use_items_repeat1, 2, 0, 0),
  ...
  [377] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_method, 1, 0, 1),
  [379] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method, 1, 0, 1),
  [381] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_item, 1, 0, 3),
  ...
  [393] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_variant_items_repeat1, 2, 0, 0), SHIFT_REPEAT(129),
  [396] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_variant_items_repeat1, 2, 0, 0),
  ...
  [404] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_flags_repeat1, 2, 0, 0), SHIFT_REPEAT(144),
  [407] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_flags_repeat1, 2, 0, 0),
  ...
  [423] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_named_ty, 3, 0, 8),
  [425] = {.entry = {.count = 1, .reusable = true}}, SHIFT(126),
  [427] = {.entry = {.count = 1, .reusable = true}}, SHIFT(71),
  [429] = {.entry = {.count = 1, .reusable = true}}, SHIFT(6),
  [431] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_method, 2, 0, 7),
  [433] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method, 2, 0, 7),
  ...
  [455] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_item, 3, 0, 6),
  ...
  [481] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variant_item, 2, 0, 5),
  ...
  [489] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_variant_payload, 3, 0, 0),
  ...
  [497] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_items, 2, 0, 0),
  ...
  [509] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_items, 3, 0, 0),
  [511] = {.entry = {.count = 1, .reusable = true}}, SHIFT(29),
  [513] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_input, 1, 0, 0),
  [515] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [517] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [519] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_items, 5, 0, 0),
  [521] = {.entry = {.count = 1, .reusable = true}}, SHIFT(142),
  [523] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [525] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_use_items, 4, 0, 0),
